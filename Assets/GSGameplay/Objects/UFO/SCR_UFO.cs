...
public class SCR_UFO : SCR_FlyingObject {
	// ==================================================
	// Const
	public const float 	UFO_SCALE 		= 1.2f;
	...
	private void Start () {
		...
		smokeParticle.transform.localScale = new Vector3 (SCR_Gameplay.SCREEN_SCALE * UFO_SCALE, SCR_Gameplay.SCREEN_SCALE * UFO_SCALE, SCR_Gameplay.SCREEN_SCALE * UFO_SCALE);
